...
* A list is a data structure used to store multiple values of similar or different data types in a single variable 
* Values in a list are sorted in a specific order  
* Lists are useful when we need to work with collections of data instead of single values
* We can iterate through every element of a list by using a loop

Real-world examples:  
* Storing marks of students
* Keeping track of user attempts
* Holding dataset values in data science and machine learning
